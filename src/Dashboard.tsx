...
const Dashboard: React.FC = () => {
  ...
  return (
    <TimerProvider>
      ...
      <div className="page page-1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#282828', color: '#fff' }}>
        <BlurText
          text="Study Helper App"
          delay={150}
          animateBy="words"
          direction="top"
          className="moon-walk big-heading"
          style={{ wordSpacing: '2.5rem' }}
        />
        <Button onExploreClick={() => goToPage(2)} />
      </div>
